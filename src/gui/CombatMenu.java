...
public class CombatMenu extends JPanel {
	...
	public CombatMenu() {
		...
		lblDefence.setFont(new Font("Copperplate Gothic Bold", Font.PLAIN, 15));
		...
		btnPause.setFont(new Font("Copperplate Gothic Bold", Font.PLAIN, 17));
		btnPause.setForeground(new Color(247, 221, 0));
		btnPause.setBackground(new Color(14, 1, 141));
		...
		lblDefenceInt.setFont(new Font("Copperplate Gothic Bold", Font.PLAIN, 15));
